...
<?php $__env->startSection('seminaire'); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 order-first order-lg-last"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/seminaires_block_block.png')); ?>" /></div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/seminaire.blade.php ENDPATH**/ ?>