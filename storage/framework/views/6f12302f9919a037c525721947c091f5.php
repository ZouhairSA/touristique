...
<?php $__env->startSection('voyage_par_carte'); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 order-first order-lg-last"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/sud_marocain_img_1.png')); ?>" /></div>
            </div>

            <div class="row">
                <div class="col-lg-6 col-md-12 "><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/sud_marocain_img_2.png')); ?>" /></div>
...
<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/voyages/carte.blade.php ENDPATH**/ ?>