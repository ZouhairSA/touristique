...
<?php $__env->startSection('voyage_organise'); ?>
    <div class="title_page"
        style="background: url('<?php echo e(asset('/img/page_voyage.jpg')); ?>') no-repeat;background-size: cover !important;">
        <div class="container">
            <div class="row">
    ...
    <div class="voyages_organises">
        <div class="container">
            <div class="row">
                <div class="col-12"><img alt="titre" class="img-fluid" src="<?php echo e(asset('/img/young_girl_steps.png')); ?>" />
...
<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/voyages/organise.blade.php ENDPATH**/ ?>