...
<body>
    ...
    <div class="title_home"
        style="background: url('<?php echo e(asset('/img/header_home_page.jpg')); ?>') no-repeat;background-size: cover !important;background-position: center;">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1>Envie de decouvrir pour reussir ?</h1>
                    <img class="img-fluid wow bounce" data-wow-duration="2.5s" data-wow-iteration="infinite"
                        src="<?php echo e(asset('/img/looking_down_arrow.png')); ?>" alt="looking_down_arrow">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 wow fadeInDown" data-wow-duration="2.5s"><img alt=" " class="img-fluid"
                        src="<?php echo e(asset('/img/businessman_holding_luggage_business_trip.jpg')); ?>" /></div>
            ...
            <div class="row">
                <div class="col-md-4  switcher_home_left wow fadeInUp" data-wow-duration="2.5s">
                    ...
                    <a href="https://auxzoneslibres.com/fr/page/carte">Decouvrir<img alt="looking_down_arrow"
                            class="img-fluid" src="<?php echo e(asset('/img/looking_down_arrow.png')); ?>" /></a>
                </div>
                <div class="col-md-8  wow slideInRight" data-wow-duration="2.5s">
                    <div class="owl-carousel nos_services_home" id="nos_services_home">
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/view_morocco_1.jpg')); ?>" /> </a> <a
                                href="#"> </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/view_morocco_2.jpg')); ?>" /> </a> <a
                                href="#"> </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/view_morocco_3.jpg')); ?>" /> </a> <a
                                href="#"> </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 wow fadeInDown" data-wow-duration="2.5s"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/young_girl_steps.png')); ?>" />
                    <div class="voyages_organises_text wow fadeInUp" data-wow-duration="2.5s">
                        ...
                        <a href="https://auxzoneslibres.com/fr/page/voyages">D&eacute;couvrir<img
                                ...
                                src="<?php echo e(asset('/img/looking_down_arrow.png')); ?>" /></a>
                    </div>
                </div>
            </div>
    ...
    <section class="footer">
        <div class="container">
            <div class="row text-center">
                <a href="/"><img src="<?php echo e(asset('/img/logo_footer.png')); ?>" class="img-fluid"
                        alt=""></a>
            </div>
            <div class="row">
                    ...
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.instagram.com/aux_zones_libres/"><img
                                    src="<?php echo e(asset('/img/instagram.png')); ?>" class="img-fluid" alt="instagram"></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="link ici"><img src="<?php echo e(asset('/img/linkedin.png')); ?>"
...
<?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/home.blade.php ENDPATH**/ ?>