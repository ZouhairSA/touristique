...
<?php $__env->startSection('contact_page'); ?>
    <style>
        @keyframes pulse {
            0% {
                transform: scale(0.9);
    ...
    <div class="content_page content_contact">
        <div class="container">
            <div class="row">
                ...
                <form class="form_contact" id="form_contact" action="<?php echo e(route('send_data_contact')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="button_submit col-lg-6 col-md-12">
                            <button type="submit" name="submit"><img class="img-fluid"
                                    src="<?php echo e(asset('/img/mail_icon.png')); ?>" alt="titre">Envoyer</button>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="info_contact info_footer">
                                <ul>
                                    <li><img src="<?php echo e(asset('/img/adresse.png')); ?>" alt="Localisation">Adresse : Résidence
                                        naim
                                        angle bd anfa et rue kawakibi 20060 casa</li>
                                    <li><img src="<?php echo e(asset('/img//tel.png')); ?>" alt="phone">Fixe : 0522 47 27 47/6 - Fax:
                                        0522
                                        47 27 45</li>
                                    <li><img src="<?php echo e(asset('/img/mail__icon.png')); ?>" alt="phone">Adresse email :
...
<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/contact.blade.php ENDPATH**/ ?>