...
<?php $__env->startSection('page_ifrane'); ?>
    <div class="title_page"
        style="background: url('<?php echo e(asset('/img/ifrane_p1.png')); ?>') no-repeat;background-size: cover !important;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  wow slideInLeft" data-wow-duration="1.5s">
                    <div class="owl-carousel nos_services_home" id="nos_services_home">
                        <div class="item_nos_produit_home position-relative">
                            <a href="#">
                                <img alt="titre" class="img-fluid" src="<?php echo e(asset('/img/MICHLIFEN.png')); ?>" /> </a> <a
                                href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/Farah.png')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid " src="<?php echo e(asset('/img/hotellY.png')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/hotellYY.png')); ?>" /> </a> <a href="#">
                            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/ifrane_p2.png')); ?>" />
                </div>
            </div>
        </div>
    </div>
    <div class="seminaires_block">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/ifrane_p3.png')); ?>" />
                </div>
                <div class="col-lg-1 col-md-0">&nbsp;</div>
                <div class="col-lg-6 col-md-12 align-self-center">
...
<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/villes/ifrane.blade.php ENDPATH**/ ?>