            ...
            <div class="row">
                <div class="col">
                    ...
                    <a href="#home_incentives_link"><img class="img-fluid wow bounce" data-wow-duration="2.5s"
                            data-wow-iteration="infinite" src="<?php echo e(asset('/img/looking_down_arrow.png')); ?>"
                ...
                <div class="col-md-8  wow slideInRight" data-wow-duration="2.5s">
                    <div class="owl-carousel nos_services_home" id="nos_services_home">
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/view_morocco_1.jpg')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/view_morocco_2.jpg')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/view_morocco_3.jpg')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/ifran1.jpg')); ?>" /> </a> <a href="#">
                            </a>
...
<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/first_page.blade.php ENDPATH**/ ?>