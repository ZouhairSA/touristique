...
<?php $__env->startSection('page_Chefchaoune'); ?>
    <link rel="stylesheet" type="text/css" href="css/checf_page.css" />

    <div class="title_page"
        style="background: url('<?php echo e(asset('/img/chefc2.jpg')); ?>') no-repeat;background-size: cover !important;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  wow slideInLeft" data-wow-duration="1.5s">
                    <div class="owl-carousel nos_services_home" id="nos_services_home">
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid " src="<?php echo e(asset('/img/hotell2.png')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/chefc4.jpg')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative"><a href="#"><img alt="titre"
                                    class="img-fluid" src="<?php echo e(asset('img/hotell4.png')); ?>" /> </a> <a href="#">
                            </a>
                        ...
                        <div class="item_nos_produit_home position-relative">
                            <a href="#">
                                <img alt="titre" class="img-fluid" src="<?php echo e(asset('/img/hotell6.png')); ?>" /> </a> <a
                                href="#">
                            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/chefchaoune_presentation1.png')); ?>" />
                </div>
            </div>
        </div>
    </div>
    <div class="seminaires_block">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/chefchaoune_presentation3.png')); ?>" />
                </div>
                <div class="col-lg-1 col-md-0">&nbsp;</div>
                <div class="col-lg-6 col-md-12 align-self-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6"><a href="/billeterie_page"><img alt="looking_down_arrow" class="img-fluid"
                            src="<?php echo e(asset('/img/mail_icon.png')); ?>" />Résérver un billet(s) </a></div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/villes/chefchaoun.blade.php ENDPATH**/ ?>