...
<?php $__env->startSection('voyage_golfique'); ?>
    <div class="title_page"
        style="background: url('<?php echo e(asset('/img/page_golf.jpg')); ?>') no-repeat;background-size: cover !important;">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 order-first order-lg-last"><img alt="titre" class="img-fluid"
                        src="<?php echo e(asset('/img/golfique_img_1.png')); ?>" /></div>
            </div>
            ...
            <div class="row golfique_block_2">
                ...
                <img alt="titre" class="img-fluid" src="<?php echo e(asset('/img/golfique_img_2.png')); ?>" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6"><a href="/contact_page"><img alt="looking_down_arrow"
                            class="img-fluid" src="<?php echo e(asset('img/mail_icon.png')); ?>" />Nous contacter</a></div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/pages/voyages/golfique.blade.php ENDPATH**/ ?>