...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-sm-2 col-xs-4">
                    <div class="logo">
                        <a href="/"><img src="<?php echo e(asset('/img/logo.png')); ?>" class="img-fluid" alt=""></a>
                    </div>
                </div>
                        ...
                        <ul class="nav justify-content-evenly ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/contact_page"> <img class="img-fluid"
                                        src="<?php echo e(asset('/img/mail_header_icon.png')); ?>" alt="logo">Nous contacter</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-md-1 col-sm-1 col-xs-1 align-self-center les_langues_desktop">
                    <a class="nav-link" href="/registrement_page"
                        ...
                        <img class="img-fluid" src="<?php echo e(asset('/img/login_icon.png')); ?>" alt="en">
                    </a>
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->yieldContent('propos'); ?>

    <?php echo $__env->yieldContent('seminaire'); ?>

    <?php echo $__env->yieldContent('contact_page'); ?>

    <?php echo $__env->yieldContent('voyage_par_carte'); ?>

    <?php echo $__env->yieldContent('voyage_golfique'); ?>

    <?php echo $__env->yieldContent('voyage_organise'); ?>

    <?php echo $__env->yieldContent('billeterie'); ?>

    <?php echo $__env->yieldContent('registrement'); ?>

    <?php echo $__env->yieldContent('page_Chefchaoune'); ?>

    <?php echo $__env->yieldContent('page_ifrane'); ?>

    <?php echo $__env->yieldContent('page_login_user'); ?>

    <?php echo $__env->yieldContent('page_login_profil'); ?>

    <?php echo $__env->yieldContent('page_voyage_reservation'); ?>

    <?php echo $__env->yieldContent('page_reservation_seul_voyage'); ?>

    <?php echo $__env->yieldContent('profil_page_id'); ?>

    <!-- footer  -->
    <section class="footer">
        <div class="container">
            <div class="row text-center">
                <a href="/"><img src="<?php echo e(asset('/img/logo_footer.png')); ?>" class="img-fluid" alt=""></a>
            </div>
            <div class="row">
                    ...
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.facebook.com/auxzoneslibres" target="_blank"><img
                                    src="<?php echo e(asset('/img/facebook.png')); ?>" class="img-fluid" alt="facebook"></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.instagram.com/aux_zones_libres/"
                                target="_blank"><img src="<?php echo e(asset('/img/instagram.png')); ?>" class="img-fluid"
                                    alt="instagram"></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.linkedin.com/feed/" target="_blank"><img
                                    src="<?php echo e(asset('/img/linkedin.png')); ?>" class="img-fluid" alt="linkedin"></a>
                        </li>
                        <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\auzone_libre\resources\views/components/principal.blade.php ENDPATH**/ ?>